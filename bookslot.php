...
<head>
    ...
    <title>Parkning Management</title>
        ...
        <div class="top-container">
            <div class="top">
                <div id="img-container">
                    <img src="./res/Lovepik_com-611622560-Vector hand drawn cartoon parking lot.png" alt=""
                        id="home-img">
                </div>
                <div class="info">
                    <h1>Park Your Vehicles Anytime!</h1>
                    <h3>Whether you're heading to work, exploring the city, or catching a flight, we've got your parking
                        needs covered. Discover a stress-free way to park - reserve your space now and experience the
                        future of parking at your fingertips</h3>
                </div>
            </div>
        </div>
        <div class="reserve">Reserve Slot</div>
            <div class="mid-container">
                ...
                <?php for ($x = 1; $x <= 4; $x++) {
                    ...
                    <div class='map-grid' id='<?php echo $x ?>'>
                    <?php while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <div class='slot <?php echo $classes?> slot-<?php echo $row['type'] ?>' onclick="<?php echo $onclick ?>">
